...
public class TheFeastBeast {
    ...
    public static boolean feast(String beast, String dish) {
        ...
        char beastLastChar = beast.charAt(beast.length() - 1);
        char dishLasChar = dish.charAt(dish.length() - 1);
        if (beastFirstChar == dishFirstChar && beastLastChar == dishLasChar) {
            return true;
        }
